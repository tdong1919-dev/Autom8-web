...
const ecosystemFeatures = [
  { icon: "🔗", title: "Algorithmic Ecosystem Marketplace", desc: "A curated library of AI workflows, agents, and automation systems — matched to your specific needs." },
  { icon: "🤝", title: "Developer ↔ User Bridge", desc: "We connect AI-native developers with non-technical business owners, users, and creators. Developers earn from their builds. Creators earn commission for bridging the gap — the first influencer marketplace built for AI automations." },
  { icon: "🎓", title: "Autom8 University", desc: "From zero to automation-native. Whether you want to become a developer, AI architect, or simply use tools to 10x your output." },
  { icon: "⚡", title: "Customized Solution Curation", desc: "No one-size-fits-all. Answer a few questions about your business and goals — we'll match you with automations that move the needle." },
  { icon: "💰", title: "Earn on the Platform", desc: "Build automations, teach courses, refer users, or create content — every contribution to the Autom8 ecosystem unlocks a real earning path." },
  { icon: "🌐", title: "Community & Collaboration", desc: "Join a network of builders, creators, and entrepreneurs reclaiming their time through intelligent automation." },
];

const universityTracks = [
  { icon: "🔰", title: "Everyday User", desc: "Learn to use AI tools to 10x your productivity — no coding required. Perfect for business owners and creators." },
  { icon: "🛠", title: "Automation Builder", desc: "Learn to build no-code workflows with n8n, Make.com, and Zapier. Connect your apps and automate your business." },
  { icon: "💻", title: "Developer Track", desc: "Go deep with APIs, AI agents, LLM integrations, and custom automation pipelines. Build, test, and monetize sophisticated AI systems." },
...
export default function DemoWaitlistPage() {
        ...
        <div className="space-y-6">
          <div className="rounded-2xl border border-primary/20 bg-primary/5 p-6 text-center">
            ...
            <p className="text-sm text-text-secondary max-w-xl mx-auto leading-relaxed">
              Learn how to develop, create, and utilize AI and automation — whether you want to become a builder or simply maximize your everyday output.
            </p>
          </div>
          <div className="grid sm:grid-cols-2 gap-4">
          ...
          <Card header={
            ...
            <div className="space-y-4">
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input type="text" placeholder="Your name" disabled
                    className="w-full bg-surface border border-border rounded-xl px-4 py-2.5 text-sm text-text-primary placeholder-text-muted outline-none opacity-60 cursor-not-allowed" />
                </div>
                <div>
              ...
              <div>
                ...
                <input type="tel" placeholder="(555) 000-0000" disabled
                  className="w-full bg-surface border border-border rounded-xl px-4 py-2.5 text-sm text-text-primary placeholder-text-muted outline-none opacity-60 cursor-not-allowed" />
              </div>
              <div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                  {roles.map((role) => (
                    <div key={role.id}
                      className="flex flex-col items-center gap-1 p-3 rounded-xl border border-border bg-surface text-center opacity-60 cursor-not-allowed">
                      <span className="text-xl">{role.icon}</span>
                      <span className="text-xs font-medium text-text-secondary">{role.title}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="rounded-xl border border-primary/20 bg-primary/5 p-4 flex flex-col sm:flex-row items-center justify-between gap-3">
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-sm text-text-secondary">
                    <span className="font-semibold text-text-primary">Start a free trial</span> to secure your spot on the exclusive waitlist.
                  </p>
                </div>
                <Link
                  href="/signup"
